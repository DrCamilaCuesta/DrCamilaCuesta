...
I am open to **on-site or remote opportunities worldwide**, and I am willing to process **visa sponsorship** if required.
...
- **Visualization & Reporting:** matplotlib, dashboards, scientific storytelling  
...
- Developed a **clinical decision-support tool using Python/R**.  
- Participated in **case competitions and peer-teaching programs**.  
- Currently involved in a **systematic review with meta-regression**.  
- Passionate about using tech to improve patient care and streamline hospital workflows.
